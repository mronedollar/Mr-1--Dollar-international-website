...
const AffiliatePage: React.FC = () => {
  ...
  const products: Product[] = [
    { id: 5, name: "Beginners Course", productId: "prod_27Sg99aDR0rye" },
    { id: 6, name: "Intermediate Course", productId: "prod_Qx2L3p9W8nK0" },
    { id: 7, name: "Advanced Course", productId: "prod_8J4mR2L7fX6t" },
    { id: 8, name: "Full Course + Free Tradecation", productId: "prod_9K2vN4X7qH1" },
    { id: 12, name: "Currencies Strategy", productId: "prod_9SrCavVpvpVfh" },
    { id: 13, name: "NFP Event Access", productId: "prod_EoyvAo4ReKJhi" },
    { id: 15, name: "Branded Merchandise", productId: "prod_4Ge1iEh1RHYGm" },
    // Trade Ideas
    { id: 1, name: "Diamond 7-Days Prepaid", productId: "prod_7x8kK9m2L3p", commission: 30 },
    { id: 2, name: "Diamond Trade Ideas", productId: "prod_Qx6RkZpD" },
    { id: 3, name: "Private Wealth VIP Black", productId: "prod_8J4mR2L7fX6t" }
  ];
  ...
  const generateAllLinks = async () => {
    ...
    const links = products.map(product => ({
      product,
      link: generateAffiliateLink(product, username)
    }));
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 max-w-4xl mx-auto">
                <div className="bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 border border-slate-800">
                  ...
                  <div className="mt-3 text-xs text-slate-500">
                    <div className="flex justify-between">
                      ...
                      <span className="text-amber-400 font-medium">5-30%</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Member Rate:</span>
                      <span className="text-green-400 font-medium">0-20%</span>
                    </div>
                  </div>
                </div>
                <div className="bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 border border-slate-800">
                ...
                <div className="bg-slate-900/50 backdrop-blur-sm rounded-xl p-6 border border-slate-800">
                  ...
                  <div className="mt-3 text-xs text-slate-500">
                    <div className="flex justify-between">
                      <span>Accuracy:</span>
                      <span className="text-blue-400 font-medium">Guaranteed</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Reports:</span>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex space-x-3">
                    <input
                      ...
                      onChange={(e) => setAffiliateUsername(e.target.value)}
                ...
                <div className="text-sm text-slate-400">
                  ...
                  <div className="bg-slate-800 rounded-lg p-4 border border-slate-700 mb-3">
                    <h4 className="font-semibold text-white mb-3">🚀 Quick Steps:</h4>
            ...
            <div className="bg-slate-900 rounded-xl p-8 border border-slate-800">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white text-sm rounded-lg transition-all duration-300 flex items-center"
                >
                  ...
                  {generatedLinks.map((item, index) => (
                    <div key={index} className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <h4 className="font-semibold text-white text-lg">{item.product.name}</h4>
                          <p className="text-slate-400 text-sm mt-1">Commission: <span className="text-amber-400 font-medium">
                            {item.product.commission ? `${item.product.commission}%` : 
                             item.product.name.includes('Diamond') && !item.product.name.includes('7-Days') ? '20%' : 
                             item.product.name.includes('Gold') || 
                             item.product.name.includes('NFP') ? '20%' : 
                             item.product.name.includes('Full Course') ||
                             item.product.name.includes('Currencies') ||
                             item.product.name.includes('Private Wealth') ? '5%' : '20%'}</span></p>
                        </div>
                        <button
                      ...
                      <div className="mt-3">
                        <div className="bg-slate-900 rounded p-3 border border-slate-700">
                          <p className="text-slate-300 text-sm mb-2">Affiliate Link:</p>
                          <div className="flex items-center space-x-2">
                            <input
                              type="text"
                              readOnly
                    ...
                    <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl p-12 border border-slate-700">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                        <div className="text-center">
                          ...
                          <p className="text-slate-400 text-sm">15 Products</p>
                        </div>
                        <div className="text-center">
          ...
          <div className="bg-slate-900 rounded-xl p-8 border border-slate-800 mb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                <h4 className="text-lg font-semibold text-amber-400 mb-4">🔥 High Commission (20-30%)</h4>
          ...
          <div className="bg-slate-900 rounded-xl p-8 border border-slate-800">
            ...
            <div className="space-y-6 text-slate-300">
              ...
              <div className="flex items-start space-x8">
