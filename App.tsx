...
>>>>>>> c8b7b09e70ab8ceb8d5f627f54b0b69ce08ade3d
];
    ...
    const partners = [
        ...
        // Prop Firms
        {
            ...
            promo: {
                ...
                dropdownContent: `
                    <div class="space-y-3">
                        <p class="text-white text-sm mb-2"><strong class="text-amber-400">Enjoy 20% Off on all Challenges.</strong></p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-xl p-6 border border-slate-700/50 hover:border-green-400/50 transition-all duration-300">
                    ...
                    <p className="text-slate-300 text-sm mb-4">Connect with fellow traders, share insights, and stay updated with the latest market trends.</p>
                    <a 
                        href="https://chat.whatsapp.com/D31nSfWdnEaEk5An7t53Ab" 
                        target="_blank" 
                        rel="noopener noreferrer"
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_cfZOzxGIk21rP?d2c=true', '_blank')}
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_cfZOzxGIk21rP"
...
const SyntheticsCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_rumeFlqobZyqj?d2c=true', '_blank')}
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg transition-colors"
                            >
                                Continue on Whop
                            </button>
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Synthetics Trade Ideas Checkout</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_rumeFlqobZyqj"
                            data-whop-checkout-return-url="https://mr1dollar.international/"
                            data-whop-checkout-theme="dark"
                            data-whop-checkout-on-complete="onCheckoutComplete"
                            style={{ minHeight: '600px' }}
...
const DiamondTradeIdeasCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Diamond Trade Ideas Checkout</h1>
...
const PrivateWealthVipBlackCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Private Wealth VIP Black Trade Ideas Checkout</h1>
...
const BeginnersCourseCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
...
const IntermediateCourseCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Intermediate Course Checkout</h1>
...
const AdvancedCourseCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Advanced Course Checkout</h1>
...
const AdvancedKeyLevelsCalculatorCheckout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Advanced Key Levels Calculator Checkout</h1>
...
const OnlineFullCourseCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Online Full Course Checkout</h1>
...
const FullCourseTradecationCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Full Course + Free Tradecation Checkout</h1>
...
const BeginnerMentorshipCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_0l3JSa0u7ie7J?d2c=true', '_blank')}
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg transition-colors"
                            >
                                Continue on Whop
                            </button>
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Beginner Mentorship Checkout</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_0l3JSa0u7ie7J"
                            data-whop-checkout-return-url="https://mr1dollar.international/"
                            data-whop-checkout-theme="dark"
                            data-whop-checkout-on-complete="onCheckoutComplete"
                            style={{ minHeight: '600px' }}
...
const IntermediateMentorshipCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_3yLCP9PECWJNW?d2c=true', '_blank')}
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg transition-colors"
                            >
                                Continue on Whop
                            </button>
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Intermediate Mentorship Checkout</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_3yLCP9PECWJNW"
                            data-whop-checkout-return-url="https://mr1dollar.international/"
                            data-whop-checkout-theme="dark"
                            data-whop-checkout-on-complete="onCheckoutComplete"
                            style={{ minHeight: '600px' }}
...
const AdvancedMentorshipCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_6WOfsWPi4NT2I?d2c=true', '_blank')}
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg transition-colors"
                            >
                                Continue on Whop
                            </button>
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Advanced Mentorship Checkout</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_6WOfsWPi4NT2I"
                            data-whop-checkout-return-url="https://mr1dollar.international/"
                            data-whop-checkout-theme="dark"
                            data-whop-checkout-on-complete="onCheckoutComplete"
                            style={{ minHeight: '600px' }}
...
const CurrenciesStrategyCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
            ...
            <div className="min-h-screen bg-black flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={() => window.open('https://whop.com/checkout/plan_9SrCavVpvpVfh?d2c=true', '_blank')}
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg transition-colors"
                            >
                                Continue on Whop
                            </button>
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Currencies Strategy Checkout</h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
                        <div
                            data-whop-checkout-plan-id="plan_9SrCavVpvpVfh"
                            data-whop-checkout-return-url="https://mr1dollar.international/"
                            data-whop-checkout-theme="dark"
                            data-whop-checkout-on-complete="onCheckoutComplete"
                            style={{ minHeight: '600px' }}
...
const NFPEventAccessCheckout: React.FC = () => {
    const [isSecure, setIsSecure] = useState(true);
    const [showSecureWarning, setShowSecureWarning] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">NFP Event Access Checkout</h1>
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const pathToPageMap: Record<string, Page> = {
      ...
      '/synthetics-checkout': 'synthetics-checkout',
      '/diamond-trade-ideas-checkout': 'diamond-trade-ideas-checkout',
      '/private-wealth-vip-black-checkout': 'private-wealth-vip-black-checkout',
      '/beginners-course-checkout': 'beginners-course-checkout',
      '/intermediate-course-checkout': 'intermediate-course-checkout',
      '/advanced-course-checkout': 'advanced-course-checkout',
      '/full-course-tradecation-checkout': 'full-course-tradecation-checkout',
      '/beginner-mentorship-checkout': 'beginner-mentorship-checkout',
      '/intermediate-mentorship-checkout': 'intermediate-mentorship-checkout',
  ...
  const renderPage = () => {
    switch(currentPage) {
      ...
      case 'synthetics-checkout':
        return <SyntheticsCheckout />;
      case 'diamond-trade-ideas-checkout':
        return <DiamondTradeIdeasCheckout />;
      case 'private-wealth-vip-black-checkout':
        return <PrivateWealthVipBlackCheckout />;
      case 'beginners-course-checkout':
        return <BeginnersCourseCheckout />;
      case 'intermediate-course-checkout':
        return <IntermediateCourseCheckout />;
      case 'advanced-course-checkout':
        return <AdvancedCourseCheckout />;
      case 'full-course-tradecation-checkout':
        return <FullCourseTradecationCheckout />;
      case 'beginner-mentorship-checkout':
        return <BeginnerMentorshipCheckout />;
      case 'intermediate-mentorship-checkout':
        return <IntermediateMentorshipCheckout />;
      case 'advanced-mentorship-checkout':
        return <AdvancedMentorshipCheckout />;
      case 'currencies-strategy-checkout':
      ...
      case 'advanced-key-levels-calculator-checkout':
        return <AdvancedKeyLevelsCalculatorCheckout />;
      case 'online-full-course-checkout':
        return <OnlineFullCourseCheckout />;
